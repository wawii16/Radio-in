    ...
    <div class="bg-neutral-900 text-white rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <form action="<?= url('registration_post')  ?>" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="<?= old('name') ?>" class="w-full p-2 border border-neutral-700 rounded-lg bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:border-transparent" required>
            </div>
            <div class="mb-4">
