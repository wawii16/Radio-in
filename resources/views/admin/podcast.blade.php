                    ...
                    <form class="p-4 md:p-5" action="{{ url('admin/podcast') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input value="<?= old('name') ?>" type="text" name="name" id="name" class="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5" placeholder="Masukkan nama podcast..." required>
                            </div>
                            <div class="col-span-2">
                                <label for="artis" class="block mb-2 text-sm font-medium text-black">Nama Podcast</label>
                            ...
                            <div class="col-span-2">
                                ...
                                <input value="<?= old('url') ?>" type="text" name="url" id="url" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5" placeholder="Masukkan url podcast..." required>
                            </div>
                            <div class="col-span-2">
                                <label class="block mb-2 text-sm font-medium text-black" for="file_input">Upload file</label>
                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-white focus:outline-none" id="file_input" type="file" accept=".png, .jpg, .jpeg" name="photo">
                            </div>
