                    ...
                    <table class="min-w-full bg-neutral-700">
                        <thead class="text-white">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left font-medium uppercase border-b border-neutral-800">Nama radio</th>
                        ...
                        <tbody class="divide-y divide-neutral-800">
                            ...
                            <tr>
                                ...
                                <td class="py-3 px-4 whitespace-nowrap border-b border-neutral-800">{{ $radio->name }}</td>
                                <td class="py-3 px-4 whitespace-nowrap border-b border-neutral-800">{{ $radio->artis }}</td>
                                <td class="py-3 px-4 whitespace-nowrap border-b border-neutral-800 text-center"> <img class="w-20 h-20" src="{{ url('/') }}/uploads/{{ $radio->photo }}" alt="Gambar">
                                </td>
                                <td class="py-3 px-4 whitespace-nowrap border-b border-neutral-800 text-center">
                                    <a href="{{ route('admin.edit_radio', ['id' => $radio->id]) }}" class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-1 px-3 rounded">Lihat</a>
                                </td>
