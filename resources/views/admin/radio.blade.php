                    ...
                    <table class="min-w-full bg-neutral-700">
                        ...
                        <tbody class="divide-y divide-neutral-800">
                            ...
                            <tr>
                                ...
                                <td class="py-1 px-2 text-xs sm:text-sm whitespace-nowrap border-b border-neutral-800">{{ $radio->name }}</td>
                                <td class="py-1 px-2 text-xs sm:text-sm whitespace-nowrap border-b border-neutral-800">{{ $radio->artis }}</td>
                                ...
                                <td class="py-1 px-2 text-xs sm:text-sm whitespace-nowrap border-b border-neutral-800 text-center">
                                    <a href="{{ route('admin.edit_radio', ['id' => $radio->id]) }}" class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-1 px-2 sm:py-1 sm:px-3 rounded">Lihat</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
