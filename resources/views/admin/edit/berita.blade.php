...
<body class="bg-gray-100">
    <h1 class="text-emerald-700 text-2xl font-bold text-center mt-6">Form Edit Berita</h1>

    <form action="{{ route('beritaUpdate', $berita->id) }}" method="POST" enctype="multipart/form-data"
        class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg mt-10">
        @method('put')
        @csrf
        <div class="grid gap-4 mb-4">
            ...
            <div class="col-span-2">
                ...
                <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-100 focus:outline-none"
            ...
            <div class="relative bg-gray-700 rounded-lg shadow">
                ...
                <form action="{{ route('beritaDestroy', $berita->id) }}" method="post">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-white">Are you sure you want to delete this news?</h3>
                        <button data-modal-hide="popup-modal" type="submit"
                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Yes, I'm sure
                        </button>
                        <button data-modal-hide="popup-modal" type="button"
                            class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-300 focus:z-10 focus:ring-4 focus:ring-gray-100">
                            No, cancel
                        </button>
                    </div>
                </form>
