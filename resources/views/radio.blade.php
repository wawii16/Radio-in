        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="text-white flex-1 mt-4">
                <ul>
                    ...
                    <li class="mb-2">
                        <a href="/radio" class="block py-2 px-4 hover:bg-gray-700 {{ request()->is('radio') ? 'bg-yellow-300 text-black' : '' }}">Radio</a>
                    </li>
                    <li class="mb-2">
    ...
    <div class="flex-1 flex flex-col overflow-hidden bg-black">
        ...
        <main class="flex-1 overflow-y-auto p-6 bg-black">
            <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <!-- Player 2 -->
                <div class="bg-neutral-700 text-white rounded-lg overflow-hidden shadow-lg">
                    <img class="w-full h-64 object-cover" src="{{ asset ('images/radio-logo-1.png') }}" alt="Album Art">
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2">PaakHouse Radio</h3>
                        <p class="">Various Artists</p>
                        <div class="flex items-center mt-4">
                            <button id="playPauseButton2" class="bg-yellow-300 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded">
                                Play
                            </button>
                            <div class="flex-1 ml-4">
                                <label for="volumeControl2" class="text-white">Volume Control</label>
                                <input type="range" id="volumeControl2" min="0" max="1" step="0.01" class="w-full bg-gray-300 h-1 rounded-lg overflow-hidden appearance-none">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Player 3 -->
                <div class="bg-neutral-700 text-white rounded-lg overflow-hidden shadow-lg">
                    <img class="w-full h-64 object-cover" src="{{ asset ('images/radio-logo-2.png') }}" alt="Album Art">
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2">Easy Hits Radio</h3>
                        <p class="">Various Artists</p>
                        <div class="flex items-center mt-4">
                            <button id="playPauseButton3" class="bg-yellow-300 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded">
                                Play
                            </button>
                            <div class="flex-1 ml-4">
                                <label for="volumeControl3" class="text-white">Volume Control</label>
                                <input type="range" id="volumeControl3" min="0" max="1" step="0.01" class="w-full bg-gray-300 h-1 rounded-lg overflow-hidden appearance-none">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Player 4 -->
                <div class="bg-neutral-700 text-white rounded-lg overflow-hidden shadow-lg">
                    <img class="w-full h-64 object-cover" src="{{ asset ('images/radio-logo-3.png') }}" alt="Album Art">
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2">Proud Radio</h3>
                        <p class="">Various Artists</p>
                        <div class="flex items-center mt-4">
                            <button id="playPauseButton4" class="bg-yellow-300 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded">
                                Play
                            </button>
                            <div class="flex-1 ml-4">
                                <label for="volumeControl4" class="text-white">Volume Control</label>
                                <input type="range" id="volumeControl4" min="0" max="1" step="0.01" class="w-full bg-gray-300 h-1 rounded-lg overflow-hidden appearance-none">
                            </div>
                        </div>
                    </div>
                </div>
